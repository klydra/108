            ...
            <div className="w-full h-[100vh] flex flex-col justify-evenly items-center">
              <div className="w-full h-full flex flex-col justify-evenly items-center gap-y-16">
                ...
                <div className="flex justify-center items-center">
                  ...
                  />
                  <div
                      className="hidden bg-card-yellow bg-card-green bg-card-blue bg-card-purple hover:bg-card-yellow hover:bg-card-green hover:bg-card-blue hover:bg-card-purple"></div>
                </div>
              </div>
                    ...
                    rightSection={
                      <Button
                          ...
                          onClick={async () => {
                            ...
                            if (join["game"]) props.navigate("/" + join["game"]);
                          }}
                      >
